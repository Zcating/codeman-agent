...
**Related**: ADR-0025 (Effect Schema as default schema library — Schema 提供 form 验证底座), ADR-0015/0016 (ProviderCard TanStack Form 模板), ADR-0023 (codeman-* namespace — codeman-toast 同源)
...
- **schema 落位**：与 ADR-0025 D6 (PR 4) "domain schema 归属 feature" 对称；Home/ChatView form schema 跟 ProviderCard 同位置（同 feature 自治）
...
- **toast CSS** 走 Tailwind v4 utility（[ADR-0006](file:///C:/Users/zcati/Documents/project/codeman-agent/docs/adr/0006-tailwind-v4-utility-styling.md)），与 `dialog.tsx` 对称
...
每 PR 单 commit（参照 [ADR-0023](file:///C:/Users/zcati/Documents/project/codeman-agent/docs/adr/0023-codeman-prefix-and-ark-ui-select.md) atomic rename 模式）：
