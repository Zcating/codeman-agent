...
- Related: ADR-0003 (Effect-TS 逻辑层), ADR-0006 (Tailwind v4), ADR-0007 (单 main 窗口), ADR-0008 (Feature-Sliced), `CONTEXT.md` § Localization, `docs/translation-rules.md`, `CONTRIBUTING.md`
