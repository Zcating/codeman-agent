...
- 与 ADR-0002 + ADR-0012 不冲突, 是延伸不是逆转
...
- pi-mono 仍跑 webview (与 ADR-0002 + ADR-0012 一致)
...
- **V1.5 sprint 不动**: 继续完成 ADR-0012 billing 迁移 + features 5+1 重构
...
- ADR-0012 (Unified Provider schema) — billing 移 TS 同进程 tool dispatch 模式
- ADR-0011 (anthropic-messages-only) — LLM 协议层
- CONTEXT.md "File IO (V2 路线图, via ADR-0013)" — 新增词汇表
