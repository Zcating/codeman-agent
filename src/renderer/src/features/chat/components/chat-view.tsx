...
//!
//! V2.8: Send/Cancel 按钮合并到同一位置 — running 时 Send 切 Stop
//! (`type=button`, `variant=destructive`, `<Square>` 图标, "停止"),
//! 通过 `<Show when={isRunning()} fallback={Send}>` 切换。覆盖 ADR-0029
//! D3/D6 "Cancel 必须为 form 外部 sibling" 的旧约束。
//!
