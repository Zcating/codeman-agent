      ...
      providers: [
        {
          ...
          llm: {
            ...
            models: [{ id: "old-model", label: "Old", thinking: false }],
      ...
      providers: [
        {
          ...
          llm: {
            ...
            baseUrl: "https://api.example.com/v1",
            apiType: "anthropic-messages" as const,
            models: [{ id: "some-model", label: "Some", thinking: false }],
            modelsEndpoint: "https://api.example.com/v1/models",
          },
        },
      ],
      ...
      providers: [
        {
          ...
          llm: {
            ...
            apiType: "anthropic-messages" as const,
            models: [
              { id: "model-A", label: "Model A", thinking: false },
              { id: "model-B", label: "Model B", thinking: false },
            ],
            modelsEndpoint: "https://api.example.com/v1/models",
          },
        },
